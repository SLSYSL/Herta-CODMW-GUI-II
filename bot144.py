...
# 内存地址配置
MEMORY_ADDRESSES = {
    "enemy_bot": ("ModernWarfare.exe", 0x17C198E4, "uint32", "敌方机器人"),
    "friendly_bot": ("ModernWarfare.exe", 0x17C198E3, "byte", "友方机器人"),
    "player_limit": ("ModernWarfare.exe", 0x15A64B7C, "uint32", "玩家上限")
}
...
def configure_and_lock(exit_flag):
    ...
    if exit_flag == False:
        ...
        # 自动设置玩家上限锁定值
        lock_values["player_limit"] = 200
        print(f"玩家上限 已设置为锁定值: 200")
